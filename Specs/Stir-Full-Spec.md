...
| `voice_substitution_disambiguated` | session_id, candidate_count, surface (voice/tap), resolved_to (free_text_fallback/user_picked_first/user_picked_second/timed_out) | matchIngredient ambiguity rate (SCA-148)   | Cook Mode               |
