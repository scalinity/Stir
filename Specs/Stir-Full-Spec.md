...
| `pantry_tier_downgrade_reconciled` | previous_tier, new_tier, archived_count, total_remembered_pre, total_remembered_post            | tier-downgrade reconciliation visibility (SCA-99 / ADR 0035)              | Reliability             |
